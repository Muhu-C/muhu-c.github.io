...
if motto || expertise || cause
    .author-content
        ...
        if cause
                .author-content-item.cause
                    .card-content
                        .author-content-item-tips= cause.tip
                        .author-content-item-tips= cause.title
                        span.author-content-item-title= cause.subtitle
                        span.author-content-item-title= cause.contenta 
                        span.author-content-item-title= cause.contentb 