...
site:
  name:
    ...
    custom: MC118CN 的博客 # Solitude / fas fa-ghost / /img/pwa/favicon.ico
  icon: /img/favicon.ico # Site icon / 网站图标
# --------------------------- end ---------------------------
...
nav:
  ...
  group:
    网站: 
      开往: https://www.travellings.cn/go.html || /fonticon/train.svg
      # 主站(未开启): https://mc118cn.cn/ || /img/avatar.png
      # 软件(未开启): https://datetimer.mc118cn.cn/ || /img/datetimer.png
    作者链接: # name
      Github: https://github.com/muhu-c/ || /fonticon/github.svg # name: url || icon
...
hometop:
  enable: true
  banner:
    title: 开荒南野际<br/>守拙归园田 # 大字
    desc:
      - 一位编程爱好者 # 小字
      - 一位普通的高中生
    icon:
      HTML: # name
        img: https:////s1.chu0.com/src/img/png/5d/5db2bb2b9f1846abac8e6e8496e7d5d8.png?imageMogr2/auto-orient/thumbnail/!282x282r/gravity/Center/crop/282x282/quality/85/%7CimageView2/2/w/282&e=2051020800&token=1srnZGLKZ0Aqlz6dk7yF4SkiYf4eP-YrEOdM1sob:MrZ9pZcFGS2hm3AQDFrNaBK5VF4= # url
        color: "#fff" # color
      CSharp:
        img: https://learn.microsoft.com/zh-cn/dotnet/media/logo_csharp.png
        color: "#9a4dff"
      Cpp:
        img: https://learn.microsoft.com/zh-cn/media/logos/logo_Cplusplus.svg
        color: "88aaff"
      Python:
        img: https://docs.python.org/3/_static/py.svg
        color: "#39f"
  group:
      编程: /categories/编程 || fas fa-code || linear-gradient(to right,#f65,#fc3)
      学习: /categories/学习 || fas fa-book-open || linear-gradient(to right,#69f,#66f)
  recommendList:
    enable: true
    sup: 木沪时间表 —— 一款时间计划软件
    title: DateTimer 2
    url: https://github.com/Muhu-C/DateTimer2/
    img: https://socialify.git.ci/Muhu-C/DateTimer2/image?description=1&forks=1&issues=1&language=1&logo=https%3A%2F%2Fraw.githubusercontent.com%2FMuhu-C%2FDateTimer%2Frefs%2Fheads%2Fmaster%2FImage%2Fdatetimer.svg&name=1&owner=1&pattern=Brick+Wall&stargazers=1&theme=Auto
    color: "#0000"
# --------------------------- end ---------------------------
...
aside:
  ...
  my_card:
    author:
      img: /img/avatar.png # url
      sticker: # url, 24x24 size
    # 介绍 / Introduction
    description: 只有迎风，风筝才能飞得更高。
    # 内容 / Content
    content: # 这是我的博客 / This is my Blog
      - MC118CN 的博客网站<br/>欢迎来到我的博客网站！<br/>本人是一名高中生<br/>本网站会分享一些编程、学习（教程）以及日常生活内容
    state:
      morning: 新的一天开始了！
      noon: 午饭吃饱有力气！
      afternoon: 下午好！
    ...
    # 社交信息图标
    information:
      Github: https://github.com/muhu-c || fab fa-github # Name: link || icon
      Bilibili: https://space.bilibili.com/1469137723 || fab fa-bilibili
  # --------------------------- end ---------------------------
...
page:
  ...
  default:
    ...
    # 未设置封面时的默认图片
    cover:
      - https://www.helloimg.com/i/2025/08/29/68b135b64e061.png # 默认图片 / default cover
# --------------------------- end ---------------------------
...
post:
  ...
  footer:
    enable: false
    desc: # Articles from MC118. / 文章来自 MC118 # description
    button: # Button
      enable: true
...
expire:
  ...
  text_prev: "这篇文章在 "
  text_next: " 天前更新，可能已经过期了！如有过时内容，请提醒我！"
# --------------------------- end ---------------------------
...
footer:
  # 社交图标
  information:
    author: /img/avatar.png # img url / false
    left:
        Github: https://github.com/muhu-c || fab fa-github # 名称: 链接 || 图标
        邮箱: mailto:mc118cn@126.com || far fa-envelope
    right:
        Bilibili: https://space.bilibili.com/1469137723 || fab fa-bilibili
        知乎: https://www.zhihu.com/people/muhu-c || fab fa-zhihu
  # 友情链接
  group:
    #  导航:
    #    Archives: /archives/
...
extends:
  ...
  head:
    ...
    # Umami
    - <script defer src="https://umami-api.mc118cn.cn/script.js" data-website-id="c8c91670-70c3-4e56-a53e-63996d7e73d5"></script>
...
twikoo: # https://twikoo.js.org/
  envId: https://mc118cn-twikoo.netlify.app/.netlify/functions/twikoo # url: https://twikoo.sondy.top/
...
# Umami 统计配置
umami:
  url: "https://umami-api.mc118cn.cn"  # 你的Umami实例URL
  website_id: "c8c91670-70c3-4e56-a53e-63996d7e73d5"  # 你的网站ID
  # 你的认证令牌
  auth_token: ""
# --------------------------- end ---------------------------
...
CDN:
  ...
  options:
    ...
    # swiper_css:
    # swiper_js:
      twikoo: https://s4.zstatic.net/ajax/libs/twikoo/1.6.44/twikoo.all.min.js
    # typeit_js:
    # valine:
    # waline_css:
    # waline_js:
